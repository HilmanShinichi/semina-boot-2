...
const createEvents = async (req) => {
  ...
  // apabila check true / data Events sudah ada maka kita tampilkan error bad request
  if (check) throw new BadRequestError("Events already exists");
